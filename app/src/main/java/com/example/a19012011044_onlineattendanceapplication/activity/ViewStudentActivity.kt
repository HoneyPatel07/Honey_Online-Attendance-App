...
class ViewStudentActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle) {
        ...
        submit = findViewById<View>(R.id.submitButton) as Button
        submit!!.setOnClickListener {
            val intent = Intent(this@ViewStudentActivity, ViewStudentByBranchYear::class.java)
